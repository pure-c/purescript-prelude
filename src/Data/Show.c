...
PURS_FFI_FUNC_DEF(Data_Show_showCharImpl, x, {
	return PURS_ANY_STRING(
		afmt("'%s'", purs_any_get_string(x)->data));
})

PURS_FFI_FUNC_DEF_2(Data_Show_showArrayImpl, f, xs, {
...
PURS_FFI_FUNC_DEF_2(Data_Show_cons, a, xs, {
...
PURS_FFI_FUNC_DEF_2(Data_Show_join, a, xs, {
	const purs_vec_t * zs = purs_any_get_array(xs);
